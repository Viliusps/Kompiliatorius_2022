...
class RTResult:
  ...
  def reset(self):
    ...
    self.method_isaccessible = False
  ...
  def success_continue(self):
    ...
    return self
  def success_security(self):
    self.reset()
    self.method_isaccessible = True
    return self
...
class Interpreter:
  ...
  def visit_SecurityNode(self, node, context):
    return RTResult().success_security()
